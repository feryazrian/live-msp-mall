                ...
                <div class="messages">
                    ...
                    <div class="delete">
                        <form method="post" action="{{ route('message.delete') }}">
                            ...
                            <button type="submit"><span class="icon-logout-white"></span></button>
                        </form>
                    </div>
                    ...
                    <div class="foot">
                        ...
                        <textarea required id="message-store" class="inline-textarea" name="content" placeholder="Ketikkan pesan yang ingin anda kirim disini (Tekan ENTER untuk kirim)" rows="1"></textarea>
                    </div>
                </div>
