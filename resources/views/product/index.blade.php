                ...
                <div class="smarttab">
                    ...
                    <div class="scroll">
                        <ul class="nav nav-tabs product bg-white">
                            <li><a href="{{ route('product.stocked') }}" class="active">Produk Dijual</a></li>
                            <li><a href="{{ route('product.stockless') }}">Produk Tidak Dijual</a></li>
                        </ul>
                    </div>
                            ...
                            @foreach ($productReady as $item)
                                ...
                                <a href="{{ route('product.edit', ['slug' => $item->slug]) }}" class="product-line">
                                    ...
                                    <div class="content">
                                        <div class="title">
                                            @if ($item->type_id == 2)
                                            <span class="voucher">E-Voucher</span>
                                            @endif
                                            {{ $item->name }}
                                        </div>
                                    ...
                                    @switch($item->status)
                                        ...
                                        @default
                                        <div class="status bg-yellow">{{ $item->action->name.' Dalam Proses' }}</div>
                                    @endswitch
