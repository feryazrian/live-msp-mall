    ...
    <div class="container">
        ...
        <div class="row">
            ...
            @endswitch
                ...
                <div class="mb-5 pb-5">
                    <form method="post" role="form" action="{{ route('product.update') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group mb-2 {{ $errors->has('condition') ? ' has-error' : '' }}{{ $errors->has('category') ? ' has-error' : '' }}">
                            ...
                            <div class="smart-input-group">
                                <select name="condition" class="form-control select select-smart select-secondary">
                                    ...
                                    <option value="1" @if($product->condition_id == 1) selected @endif >Baru</option>
                                    <option value="2" @if($product->condition_id == 2) selected @endif >Bekas</option>
                                </select>
                        ...
                        <div class="form-group mb-2 {{ $errors->has('weight') ? ' has-error' : '' }}">
                            <input type="number" required value="{{ $product->weight }}" class="numeric form-control" name="weight" placeholder="Berat Produk (Gram)" />
                        ...
                        <div class="form-group mb-4 {{ $errors->has('point') ? ' has-error' : '' }}">
                            <input type="number" value="{{ $product->point }}" class="numeric form-control" name="point" placeholder="Persentase Pembayaran via Point (Max: {{ $max_point.'%' }})" />
                        ...
                        <div class="form-group mb-2 {{ $errors->has('preorder') ? ' has-error' : '' }}">
                            <select name="preorder" class="form-control select select-smart select-secondary select-preorder">
                                ...
                                <option value="0" @if($product->preorder == 0 AND !$errors->has('preorder_target') AND !$errors->has('preorder_expired')) selected @endif >Produk Tersedia</option>
                                <option value="1" @if($product->preorder == 1 || $errors->has('preorder_target') || $errors->has('preorder_expired')) selected @endif >Produk Group Buy</option>
                            </select>
                        ...
                        <div class="form-preorder" @if($product->preorder == 0 AND !$errors->has('preorder_target') AND !$errors->has('preorder_expired')) style="display: none;" @endif>
                            <div class="form-group mb-2 {{ $errors->has('preorder_target') ? ' has-error' : '' }}">
                                <input type="number" name="preorder_target" value="{{ $product->preorder_target }}" class="numeric form-control" placeholder="Target Group Buy (Buah)" />
                            ...
                            <div class="form-group mb-4 {{ $errors->has('preorder_expired') ? ' has-error' : '' }}">
                                <input type="text" value="{{ $product->preorder_expired }}" class="form-control datetime" data-field="datetime" readonly name="preorder_expired" placeholder="Batas Waktu Group Buy" />
