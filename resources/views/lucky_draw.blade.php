...
<body>
  ...
  <div class="row">
    ...
    <div class="col-2 col-sm-2"></div> {{-- left --}}
      <div class="col-md-12">
    ...
    <div class="col-2 col-sm-2"></div> {{-- right --}}
    </div>
    </div>

    <div class="row">
      <div class="col-1 col-sm-1"></div> {{-- left --}}
      <div class="col-10">
       ...
       <div class="col-1 col-sm-1"></div> {{-- right --}}
    </div>

    <div class="row">
      <div class="col-2 col-lg-2"></div> {{-- left --}}
      <div class="col-8">
      ...
      <div class="col-2 col-lg-2"></div> {{-- right --}}
    </div>
