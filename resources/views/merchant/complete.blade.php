        ...
        <div class="row">
            ...
            <div class="merchant join col-md-12 col-lg-9">
                ...
                <div class="notif text-center mb-5 pb-5">
                    ...
                    <div class="content">Formulir sedang dalam tahap menunggu persetujuan oleh Administrator.<br/><br/>Anda akan dapat mulai berjualan setelah formulir di setujui oleh Administrator.</div>
                </div>
